...
bool S_DungeonSecondFloorCentre::Start()
{
	...
	if (App->map->Load("Dungeon SecondLevel Up.tmx") == true)
...
bool S_DungeonSecondFloorCentre::Update()
{
...
bool S_DungeonSecondFloorCentre::PostUpdate()
{
...
bool S_DungeonSecondFloorCentre::Clean()
{
