...
{
	IngamemenuLabel = App->gui->CreateButton(iPoint(100,100), &std::string(conf.child("Label").attribute("value").as_string("In-Game menu")), ButtonType::idle_only, &label_title_rec, false);
