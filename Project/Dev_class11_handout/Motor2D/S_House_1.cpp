...
bool S_House_1::Start()
{
	scene_str = "Empty House";
	...
	if (App->map->Load("casa 1.tmx") == true)
	{
		int w, h = 0;
		uchar* data = nullptr;
...
bool S_House_1::Update()
{

	return false;
}

bool S_House_1::PostUpdate()
{
...
bool S_House_1::Save(pugi::xml_node& node) const
{
	return true;
}

bool S_House_1::Load(pugi::xml_node& node)
{
	return true;
}