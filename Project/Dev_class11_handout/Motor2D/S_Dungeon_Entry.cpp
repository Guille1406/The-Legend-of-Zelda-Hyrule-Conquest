...
bool S_DungeonEntry::Update()
{
	if (App->input->GetKey(SDL_SCANCODE_Z) == KEY_DOWN) {
		App->object->CreateBridge({ App->player->Link->pos.x,App->player->Link->pos.y,128,64 },0);
	}
...
bool S_DungeonEntry::PostUpdate()
{
