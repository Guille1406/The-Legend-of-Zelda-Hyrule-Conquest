...
void GuiImage::DrawWithAlternativeAtlas(SDL_Texture* alternativeatlas, bool usecam)
{
	SubDrawFunction(alternativeatlas, usecam);
}

void GuiImage::SubDrawFunction(SDL_Texture* atlas, bool usecam)
{
