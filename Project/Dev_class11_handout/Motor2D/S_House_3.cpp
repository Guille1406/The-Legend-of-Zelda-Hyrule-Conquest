...
bool S_House_3::Start()
{
	...
	if (App->map->Load("casa 3.tmx") == true)
	{
		int w, h = 0;
		uchar* data = nullptr;
...
bool S_House_3::Update()
{

	return false;
}

bool S_House_3::PostUpdate()
{
...
bool S_House_3::Save(pugi::xml_node& node) const
{
	return true;
}

bool S_House_3::Load(pugi::xml_node& node)
{
	return true;
}